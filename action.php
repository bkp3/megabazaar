						...
						<div class='col-md-4'>
			 				<div class='panel panel-info'>
			 					...
			 					<div class='panel-body'>
			 						<img src='admin/c/$pro_image' width='180' height='150'>
			 					</div>
		...
		if(isset($_POST["addToProduct"])){
			...
			if($count>0){
				...
				<div class='alert alert-warning'>
						...
						<b>Product is already added into the cart continue shpping...!</b>
	...
	if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
		...
		if($count>0){
			...
			while($row=mysqli_fetch_array($run_query)){
				...
				if(isset($_POST["get_cart_product"])){
					...
					<div class='row'>
		    					...
		    					<div class='col-md-3'><img src='admin/c/$pro_image' width='60px' height='50px'></div>
				...
				$no=$no + 1;
					...
					echo "
						...
						<div class='row'>
							...
							<div class='col-md-2'><img src='admin/c/$pro_image' width='60px' height='60px'></div>
			...
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
			  ...
			  <input type="hidden" name="business" value="shoppingcart123bkp@gmail.com">
			  ...
			  echo '<input style="float:right" type="image" name="submit"
