...
<body>
	...
	<div class="container-fluid">
		...
		<div class="container">
			<h1><center>Insert Brand</center></h1><br><br>
			<form action="" method="post" enctype="multipart/form-data">
			<table class="table">
				<tr>
					<td>Brand Title</td>
					<td><input type="text" name="brand_title" placeholder="Enter Brand Title" class="form-control" required="required"></td>
				</tr>
			...
			if(isset($_POST['sub']))
			{
				...
				if(mysqli_query($conn,"insert into brand(brand_title) values('$brand_title')"))
				{
